...
// console.log(movies[0].genres[genres.length]); // giving array don,t knwo why ?
...
for( let music of movies[0].genres){
  console.log(music);
}
// 19. Log all the genres of the second movie one by one
for( let music of movies[1].genres){
  console.log(music);
}
...
for(let movieyear = 0; movieyear<movies.length ; movieyear++){
  if(movies[movieyear].year>2017){
    console.log(true);
  }
  else{
    console.log(false);
...
if(movies[0].title === 'Hannah' ){
  console.log(`Movies title is Hannah`);
}
else {
  console.log(`Movies title is not Hannah`);
}
...
for(let movieyear = 0; movieyear<movies.length ; movieyear++){
  if(movies[movieyear].year==2018){
    console.log(movies[movieyear].title);
  }
}
