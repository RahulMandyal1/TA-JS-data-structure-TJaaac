...
for(let i =0; i<=Object.keys(students).length ; i= i+1){
     console.log(`the length is ${i}`);
}
// 11. Can you define a key of `let or var` in any object? Reason.
// Yes we can  define  a key named as  let  var and any other special  pre reserved word  in the javascript 
// Because The key name is a string  in  javscript so 'let ' and let both are different
